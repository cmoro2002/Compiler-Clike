...
block.addComment("Estructura IF");
    t = jj_consume_token(tIF);
    jj_consume_token(tLPARENTESIS);
    a = Expresion(block);
if (a.constante) {
                        errSem.warning("La condicion es constante", t);
                }
...
//----------------------   WHILE    ----------------------
  static final public void While(Symbol.Types tipo, CodeBlock block) throws ParseException {Attributes a = null;
        ...
        Token t;
    t = jj_consume_token(tWHILE);
    jj_consume_token(tLPARENTESIS);
block.addComment("Estructura WHILE");
                block.addLabel(labelInicio);
    a = Expresion(block);
if (a.constante) {
                        errSem.warning("Nunca se va a salir de este bucle", t);
                }
...
atributo = new Attributes(Symbol.Types.INT,Symbol.ParameterClass.NONE,Integer.parseInt(t.image));
  ...
  static private boolean jj_2_12(int xla)
 {
  ...
  static private boolean jj_3R_Vars_1035_9_46()
 {
    if (jj_scan_token(tCOMA)) return true;
    return false;
  }

  static private boolean jj_3R_FuncYDeclaracion_464_9_33()
 {
    if (jj_3R_Funcs_469_9_41()) return true;
    return false;
  }
  ...
  static private boolean jj_3R_FuncYDeclaracion_463_9_24()
 {
    ...
    if (jj_3_2()) {
    jj_scanpos = xsp;
    if (jj_3R_FuncYDeclaracion_464_9_33()) return true;
    }
    return false;
  }
 ...
 {
    if (jj_3R_Def_979_9_25()) return true;
    return false;
  }

  static private boolean jj_3R_Def_1024_18_36()
 {
    if (jj_3R_Vars_1035_9_46()) return true;
    return false;
  }

  static private boolean jj_3R_Factor_1791_9_48()
 {
    if (jj_scan_token(tNOT)) return true;
    return false;
  }

  static private boolean jj_3R_Factor_1790_9_47()
 {
    if (jj_3R_Primario_1823_17_53()) return true;
    return false;
  }

  static private boolean jj_3R_Factor_1790_9_39()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Factor_1790_9_47()) {
    jj_scanpos = xsp;
    if (jj_3R_Factor_1791_9_48()) return true;
    }
    return false;
  }

  static private boolean jj_3R_Primario_1874_17_59()
 {
 ...
 {
    if (jj_3R_Op_MAS_MENOS_1723_9_29()) return true;
    if (jj_3R_Termino_1734_9_30()) return true;
    return false;
  }
 ...
 {
    if (jj_3R_Op_MAS_MENOS_1723_9_29()) return true;
    if (jj_3R_Termino_const_1994_9_32()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(tID)) return true;
    if (jj_3R_vector_714_9_28()) return true;
    return false;
  }
 ...
 {
    if (jj_3R_FuncYDeclaracion_463_9_24()) return true;
    return false;
  }

  static private boolean jj_3_6()
 {
    if (jj_3R_LlamaProced_858_9_27()) return true;
    return false;
  }
  ...
  static private boolean jj_3_5()
 {
  ...
  static private boolean jj_3R_Primario_const_2033_17_50()
 {
    if (jj_scan_token(tDIGITO)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_const_2032_17_49()
 {
    if (jj_scan_token(tLPARENTESIS)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_const_2032_17_40()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Primario_const_2032_17_49()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_const_2033_17_50()) return true;
    }
    return false;
  }
  ...
  static private boolean jj_3_4()
 {
  ...
  static private boolean jj_3R_Def_983_17_35()
 {
    if (jj_3R_vector_const_730_9_45()) return true;
    return false;
  }
  ...
  static private boolean jj_3_3()
 {
  ...
  static private boolean jj_3R_Primario_1832_17_58()
 {
    if (jj_scan_token(tCHAR2INT)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1924_17_64()
 {
    if (jj_scan_token(tENTRECOMILLASSIMPLES)) return true;
    return false;
  }

  static private boolean jj_3R_Def_979_9_25()
 {
    if (jj_3R_TipoVal_500_5_34()) return true;
    if (jj_scan_token(tID)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Def_983_17_35()) jj_scanpos = xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_Def_1024_18_36()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(tPCOMA)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1919_17_63()
 {
    if (jj_scan_token(tENTRECOMILLAS)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1824_17_57()
 {
    if (jj_scan_token(tINT2CHAR)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1823_17_56()
 {
    if (jj_scan_token(tLPARENTESIS)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1823_17_53()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Primario_1823_17_56()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1824_17_57()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1832_17_58()) {
    jj_scanpos = xsp;
    if (jj_3_10()) {
    jj_scanpos = xsp;
    if (jj_3_11()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1874_17_59()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1894_17_60()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1903_17_61()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1911_17_62()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1919_17_63()) {
    jj_scanpos = xsp;
    if (jj_3R_Primario_1924_17_64()) return true;
    }
    }
    }
    }
  ...
  static private boolean jj_3R_Termino_1734_9_30()
 {
    if (jj_3R_Factor_1790_9_39()) return true;
    return false;
  }

  static private boolean jj_3R_TipoVal_502_5_44()
 {
    if (jj_scan_token(tBOOL)) return true;
    return false;
  }

  static private boolean jj_3R_TipoVal_501_5_43()
 {
    if (jj_scan_token(tCHAR)) return true;
    return false;
  }

  static private boolean jj_3R_TipoVal_500_5_34()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_TipoVal_500_5_42()) {
    jj_scanpos = xsp;
    if (jj_3R_TipoVal_501_5_43()) {
    jj_scanpos = xsp;
    if (jj_3R_TipoVal_502_5_44()) return true;
    }
    }
    return false;
  }

  static private boolean jj_3R_TipoVal_500_5_42()
 {
    if (jj_scan_token(tINT)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1911_17_62()
 {
    if (jj_scan_token(tFALSE)) return true;
    return false;
  }

  static private boolean jj_3R_Op_MAS_MENOS_1724_9_38()
 {
    if (jj_scan_token(tMENOS)) return true;
    return false;
  }

  static private boolean jj_3R_Op_MAS_MENOS_1723_9_29()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Op_MAS_MENOS_1723_9_37()) {
    jj_scanpos = xsp;
    if (jj_3R_Op_MAS_MENOS_1724_9_38()) return true;
    }
    return false;
  }

  static private boolean jj_3R_Op_MAS_MENOS_1723_9_37()
 {
    if (jj_scan_token(tMAS)) return true;
    return false;
  }

  static private boolean jj_3R_Primario_1903_17_61()
 {
  ...
  static private boolean jj_3R_Proced_581_9_55()
 {
  ...
  static private boolean jj_3R_LlamaProced_858_9_27()
 {
    if (jj_scan_token(tID)) return true;
    if (jj_scan_token(tLPARENTESIS)) return true;
    return false;
  ...
  static private boolean jj_3R_Primario_1894_17_60()
 {
    if (jj_scan_token(tDIGITO)) return true;
    return false;
  }

  static private boolean jj_3R_Termino_const_1994_9_32()
 {
    if (jj_3R_Primario_const_2032_17_40()) return true;
    return false;
  }

  static private boolean jj_3R_Funcs_470_9_52()
 {
    if (jj_3R_Proced_581_9_55()) return true;
    return false;
  }

  static private boolean jj_3R_Funcs_469_9_51()
 {
    if (jj_3R_Func_514_9_54()) return true;
    return false;
  }

  static private boolean jj_3R_Funcs_469_9_41()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_Funcs_469_9_51()) {
    jj_scanpos = xsp;
    if (jj_3R_Funcs_470_9_52()) return true;
    }
    return false;
  }
